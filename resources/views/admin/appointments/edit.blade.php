            ...
            <div class="bg-white shadow-sm rounded-lg p-6">
                ...
                <form action="{{ route('admin.appointments.update', $appointment) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name="email" value="{{ old('email', $appointment->email) }}"
                               class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-indigo-200"
                               required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="phone_number" value="{{ old('phone_number', $appointment->phone_number) }}"
                               class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-indigo-200"
                               required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm font-bold text-gray-700 mb-2">Produk</label>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-bold text-gray-700 mb-2">Other Product</label>
                        <input type="text" name="other_product" value="{{ old('other_product', $appointment->other_product) }}"
                               class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-indigo-200">
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm font-bold text-gray-700 mb-2">Tanggal Meeting</label>
                        <input type="date" name="meeting_at" value="{{ old('meeting_at', optional($appointment->meeting_at)->format('Y-m-d')) }}"
                               class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-indigo-200"
                               required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm font-bold text-gray-700 mb-2">Brief</label>
